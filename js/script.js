/* Darsga Topshiriq:
1) Inputni to'ldirgandan so'ng va "Tasdiqlash" tugmachasini bosgandan so'ng ro'yxatga yangi yangilik qo'shilish kerak.
Sahifa qayta yuklanmasligi kerak. 
...
document.addEventListener("DOMContentLoaded", () => {
    const news = ["FOOTBALL", "BASKETBALL", "UFC", "BOX", "AMERICAN FOOTBAL IN EU..."];
    ...
    addForm.addEventListener("submit", (event) => {
        ...
        // agar funksiyani yaratilayotganda event ishlatilmagan bo'lsa, pastdagi variantda ishlanadi:
        addInput.value = "";
    });
